...
const Statistics = () => {
    ...
    // 2. Clase base para animar los números suavemente y ocultarlos mientras carga
    const numberStyle = `text-2xl font-bold transition-opacity duration-200 ${
        !isMounted || stats.isLoading ? 'opacity-0' : 'opacity-100'
    }`;
        ...
        <div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div className="p-4 rounded-2xl bg-primary/5 border border-border flex flex-col items-center justify-center">
                    ...
                    {/* 3. Forzamos el 0 en el servidor, y mostramos el valor real en el cliente */}
                    <span className={`${numberStyle} text-primary`}>
                        {isMounted ? stats.currentStreak : 0}
                    </span>
                ...
                <div className="p-4 rounded-2xl bg-amber-500/5 border border-border flex flex-col items-center justify-center">
                    ...
                    <span className={`${numberStyle} text-amber-500`}>
                        {isMounted ? stats.longestStreak : 0}
                    </span>
                ...
                <div className="p-4 rounded-2xl bg-blue-500/5 border border-border flex flex-col items-center justify-center">
                    ...
                    <span className={`${numberStyle} text-blue-500`}>
                        {isMounted ? stats.totalDays : 0}
                    </span>
